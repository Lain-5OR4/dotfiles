# Generated by Powerlevel10k configuration wizard on 2023-06-24 at 18:11 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=212
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=126
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=112
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=126
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=55
  ...
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=14
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_CPU_ARCH_FOREGROUND=12
  typeset -g POWERLEVEL9K_CPU_ARCH_BACKGROUND=164
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=53
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=3
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=53
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=75
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=53
